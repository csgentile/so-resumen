...
Cuando hay varias cosas por hacer, ¿cómo podemos elegir qué hacer primero? En los últimos capítulos, hemos descrito cómo crear hilos, intercalar entre ellos y sincronizar su acceso a los datos compartidos. En momento dado, algunos hilos se están ejecutando en el procesador. Otros están esperando su turno para ocupar el procesador. Mientras otros se bloquean esperando que se complete alguna E/S, se señale una variable de condición o se libere un bloqueo. Cuando hay más hilos que procesadores, la \textbf{política de programación del procesador} determina qué hilos ejecutar primero.
